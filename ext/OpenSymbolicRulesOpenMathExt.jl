...
const _OSR_TO_OPENMATH = Dict{Symbol, OpenMath.OMSymbol}(
    ...
    :Cot => OpenMath.OMSymbol("transc1", "cot"),
    :Sec => OpenMath.OMSymbol("transc1", "sec"),
    :Csc => OpenMath.OMSymbol("transc1", "csc"),
    :Sinh => OpenMath.OMSymbol("transc1", "sinh"),
    :Cosh => OpenMath.OMSymbol("transc1", "cosh"),
    :Tanh => OpenMath.OMSymbol("transc1", "tanh"),
    :Coth => OpenMath.OMSymbol("transc1", "coth"),
    :Sech => OpenMath.OMSymbol("transc1", "sech"),
    :Csch => OpenMath.OMSymbol("transc1", "csch"),
    :Asin => OpenMath.OMSymbol("transc1", "arcsin"),
    :Acos => OpenMath.OMSymbol("transc1", "arccos"),
    :Atan => OpenMath.OMSymbol("transc1", "arctan"),
    :Acot => OpenMath.OMSymbol("transc1", "arccot"),
    :Asec => OpenMath.OMSymbol("transc1", "arcsec"),
    :Acsc => OpenMath.OMSymbol("transc1", "arccsc"),
    :Asinh => OpenMath.OMSymbol("transc1", "arcsinh"),
    :Acosh => OpenMath.OMSymbol("transc1", "arccosh"),
    :Atanh => OpenMath.OMSymbol("transc1", "arctanh"),
    :Acoth => OpenMath.OMSymbol("transc1", "arccoth"),
    :Asech => OpenMath.OMSymbol("transc1", "arcsech"),
    :Acsch => OpenMath.OMSymbol("transc1", "arccsch"),
